...
import com.stardew.GameLogic.Enums.FishKind;
import com.stardew.GameLogic.Enums.ItemType;
import com.stardew.GameLogic.Models.Game.App;
import com.stardew.GameLogic.Models.Items.Fish;
...
public class Fishing {
    ...
    public void fishing(){
        if(App.getGame().getCurrentPlayer().backpack.getItemInHand() == null){
            MessageManager.getMessage(Result.failure("No item in hand."));
            return;
        }
        ...
        MessageManager.getMessage(Result.success("You caught " + quantity + " fishes."));
    }
}
