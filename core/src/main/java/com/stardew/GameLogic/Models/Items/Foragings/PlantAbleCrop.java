package com.stardew.GameLogic.Models.Items.Foragings;


import com.stardew.GameLogic.Enums.ItemType;
import com.stardew.GameLogic.Enums.Season;
...
public class PlantAbleCrop extends Plant {
    ...
    public String details() {
        ...
        return "Name : " + itemType.name() + "\n" +
                "Source : " + sourceSeed.getItemType().name() + "\n" +
                "Stages : " + string.substring(0, string.length() -2)+ "\n" +
                "Total Harvest Time : " + totalHarvest + "\n" +
                "Number of growths : " + remainingGrowthTimes + "\n" +
    ...
    public static final PlantAbleCrop CoffeeBean = new PlantAbleCrop(ItemType.CoffeeBean,
            ForagingSeed.CoffeeBean, 3, new int[]{2,2,3,2}, Plant.springSummer, false).makeSellPrice(15);
    ...
    public static final PlantAbleCrop Blueberry = new PlantAbleCrop(ItemType.Blueberry,
            ForagingSeed.BlueberrySeeds, 5, new int[]{3,3,4,2}, Plant.summer, false).makeEdible(25).makeEdible(50);
    ...
    public static final PlantAbleCrop SummerSquash = new PlantAbleCrop(ItemType.SummerSquash,
            ForagingSeed.SummerSquashSeeds, 4, new int[]{1,1,2,1}, Plant.summer, false).makeEdible(63).makeSellPrice(45);
    ...
    public static final PlantAbleCrop Tomato = new PlantAbleCrop(ItemType.Tomato,
            ForagingSeed.TomatoSeeds, 5, new int[]{2,2,2,2,3}, Plant.summer, false).makeEdible(20).makeSellPrice(60);
    ...
    public static final PlantAbleCrop Broccoli = new PlantAbleCrop(ItemType.Broccoli,
            ForagingSeed.BroccoliSeeds, 5, new int[]{2,2,2,2}, Plant.fall, false).makeEdible(63).makeSellPrice(70);

    public static final PlantAbleCrop Cranberry = new PlantAbleCrop(ItemType.Cranberry,
            ForagingSeed.CranberrySeeds, 6, new int[]{2,1,1,2}, Plant.fall, false).makeEdible(38).makeSellPrice(75);

    public static final PlantAbleCrop Eggplant = new PlantAbleCrop(ItemType.Eggplant,
            ForagingSeed.EggplantSeeds, 6, new int[]{1,1,1,1}, Plant.fall, false).makeEdible(20).makeSellPrice(60);
    ...
    public static final PlantAbleCrop AncientFruit = new PlantAbleCrop(ItemType.AncientFruit,
            ForagingSeed.AncientSeeds, 8, new int[]{7,7,7,5}, Plant.springSummerFall, false).makeSellPrice(550);
